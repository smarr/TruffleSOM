...
public final class UninitIncFieldWithExpNode extends FieldNode {
  ...
  public UninitIncFieldWithExpNode(final ExpressionNode self, final ExpressionNode valueExpr,
  ...
  public Object executeGeneric(final VirtualFrame frame) {
    ...
    IncFieldWithExpNode incNode = new IncFieldWithExpNode(self, valueExpr, node, sourceCoord);
    replace(incNode);
