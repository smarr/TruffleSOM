...
public abstract class ToArgumentsArrayNode extends NoPreEvalExprNode {
  ...
  public static final Object[] doEmptyArray(final SArray somArray, final Object rcvr) {
  ...
  private static Object[] addRcvrToObjectArray(final Object rcvr, final Object[] storage) {
  ...
  public static final Object[] doPartiallyEmptyArray(final SArray somArray,
      final Object rcvr) {
  ...
  public static final Object[] doObjectArray(final SArray somArray,
      final Object rcvr) {
    return addRcvrToObjectArray(rcvr, somArray.getObjectStorage());
  }

  @Specialization(guards = "somArray.isLongType()")
  public static final Object[] doLongArray(final SArray somArray,
      final Object rcvr) {
  ...
  public static final Object[] doDoubleArray(final SArray somArray,
      final Object rcvr) {
  ...
  public static final Object[] doBooleanArray(final SArray somArray,
      final Object rcvr) {
